...
SOURCE_DISCOVERY_MODULE_VERSION = "dynamic_discovery_v3q_v2w4_polygon_direct_distribution_injection_2026_06_21"
...
def build_dynamic_universe(max_symbols: int = 700) -> list[str]:
    ...
    try:
        ...
        for item in (next_day_payload.get("candidates") or [])[:260]:
            ...
            _add_candidate(candidates, sym, base_score, "polygon_next_day_builder", reason, {
                ...
                "polygon_next_day_reasons_ar": reasons[:8],
    ...
    diag = {
        "engine_version": "dynamic_discovery_v3q_v2w4_polygon_direct_distribution_injection_2026_06_21",
        "dynamic_discovery_enabled": True,
        "dynamic_discovery_mode": "real_pre_explosion_capture_v2w4_polygon_direct_distribution_injection_fast_promotion",
        ...
        "live_tight_monitoring_v2v_rule_ar": "V2W4: Prepared/V2V/Low-Float/Fast Lane محمية، وPolygon يعمل كمصدر خلفي مباشر يوزع على القوائم الحالية حتى إذا فقدت صفوف trade-scan وسم Polygon. Catalyst لا يظهر إلا بوجود خبر/محفز حقيقي.",
