...
SOURCE_DISCOVERY_MODULE_VERSION = "dynamic_discovery_v3r_v2w5_live_price_refresh_guard_2026_06_22"
...
def build_dynamic_universe(max_symbols: int = 700) -> list[str]:
    ...
    diag = {
        "engine_version": "dynamic_discovery_v3r_v2w5_live_price_refresh_guard_2026_06_22",
        "dynamic_discovery_enabled": True,
        "dynamic_discovery_mode": "real_pre_explosion_capture_v2w5_live_price_refresh_guard_fast_promotion",
        ...
        "live_tight_monitoring_v2v_rule_ar": "V2W5: Prepared/V2V/Low-Float/Fast Lane محمية، وPolygon يعمل كمصدر خلفي مباشر؛ والأسعار أثناء التداول/البري/بعد الإغلاق تُركّب من FMP حديثًا حتى لا تبقى بطاقات القوائم على سعر الإغلاق القديم.",
