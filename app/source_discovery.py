...
SOURCE_DISCOVERY_MODULE_VERSION = "dynamic_discovery_v3v_v2w8_tomorrow_prep_session_builder_2026_06_23"
...
def build_dynamic_universe(max_symbols: int = 700) -> list[str]:
    ...
    diag = {
        "engine_version": "dynamic_discovery_v3v_v2w8_tomorrow_prep_session_builder_2026_06_23",
        "dynamic_discovery_enabled": True,
        "dynamic_discovery_mode": "real_pre_explosion_capture_v2w8_tomorrow_prep_session_builder_fast_promotion",
        ...
        "live_tight_monitoring_v2v_rule_ar": "V2W5b: Prepared/V2V/Low-Float/Fast Lane محمية، وPolygon يعمل كمصدر خلفي مباشر؛ وتم إصلاح ربط /trade-scan بعد V2W5 حتى لا تتصفر القوائم مع بقاء تحديث الأسعار.",
