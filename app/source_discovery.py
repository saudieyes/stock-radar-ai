...
SOURCE_DISCOVERY_MODULE_VERSION = "dynamic_discovery_v3u_v2w7_visible_cards_price_sweep_2026_06_22"
...
def build_dynamic_universe(max_symbols: int = 700) -> list[str]:
    ...
    diag = {
        "engine_version": "dynamic_discovery_v3u_v2w7_visible_cards_price_sweep_2026_06_22",
        "dynamic_discovery_enabled": True,
        "dynamic_discovery_mode": "real_pre_explosion_capture_v2w7_visible_cards_price_sweep_fast_promotion",
