...
LIVE_MONITORING_FMP_CONFIRM_TOTAL_LIMIT = _env_int("LIVE_MONITORING_FMP_CONFIRM_TOTAL_LIMIT", 320, 80, 560)
LIVE_MONITORING_PREPARED_CONFIRM_LIMIT = _env_int("LIVE_MONITORING_PREPARED_CONFIRM_LIMIT", 140, 30, 320)
LIVE_MONITORING_MEMORY_CONFIRM_LIMIT = _env_int("LIVE_MONITORING_MEMORY_CONFIRM_LIMIT", 80, 20, 200)
LIVE_MONITORING_RANKED_CONFIRM_LIMIT = _env_int("LIVE_MONITORING_RANKED_CONFIRM_LIMIT", 140, 40, 300)
LIVE_MONITORING_MICRO_MEMORY_CONFIRM_LIMIT = _env_int("LIVE_MONITORING_MICRO_MEMORY_CONFIRM_LIMIT", 50, 10, 160)
LIVE_MONITORING_SEED_CONFIRM_LIMIT = _env_int("LIVE_MONITORING_SEED_CONFIRM_LIMIT", 60, 10, 180)
...
def _live_monitoring_confirmation_budget(
    *,
    ...
    if not LIVE_MONITORING_BUDGET_GUARD_ENABLED:
        ...
        return raw, {
            "version": "live_monitoring_budget_guard_v2v6_2026_06_21",
            "enabled": False,
            "final_count": len(raw),
...
def build_dynamic_universe(max_symbols: int = 700) -> list[str]:
    ...
    diag = {
        "engine_version": "dynamic_discovery_v3k_v2v6_live_budget_guard_2026_06_21",
        "dynamic_discovery_enabled": True,
        "dynamic_discovery_mode": "real_pre_explosion_capture_v2v6_live_budget_guard_fast_promotion",
